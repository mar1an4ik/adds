...
export const PostAlone=(props)=>{
    ...
    const Posts=(props)=>{
        ...
        const editTitleDiv=<div><textarea  cols={40}  ref={ref} value={readyTitle} onChange={newTitle} /></div>;
        const editDescrDiv=<div><textarea   cols={120} rows={10} ref={ref2} value={readyDescr} onChange={newDescr}  /></div>;
